    ...
    function drawList() {
      ...
      document.getElementById("list").innerHTML="";
        ...
        y.setAttribute("border","1px solid black");
        ...
        for (let r = 0; r < pageList.length; r++)
        {
            ...
            var z1 = document.createElement("TD");
            var t1 = document.createTextNode(obj.name);
            z1.setAttribute("width","25%");
            z1.appendChild(t1);
            
            var z2 = document.createElement("TD");
            var t2 = document.createTextNode(obj.email);
            z2.setAttribute("width","100%");
            z2.appendChild(t2);
            ...
            x.append(y);
            document.getElementById("list").append(x);
            document.getElementById("myTr1").style.fontWeight = 'bold';
          }
